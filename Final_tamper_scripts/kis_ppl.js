...
document.querySelector("#container > div > main > div > header").innerHTML+=
`<button style="color:white; background-color:#100072" onclick ="recheck()">отмена V</button>`
...
//   result.replace(/[\n\r+�]+/g, '');
test_data0 = result.replace(/[+-\d]+/g, '');
test_data1 = test_data0.split("\n").join(",")
test_data = test_data1.split(",")
var test_data2 = []
